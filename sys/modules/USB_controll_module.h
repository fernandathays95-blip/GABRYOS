#ifndef USB_CONTROLL_MODULE_H
#define USB_CONTROLL_MODULE_H

#include <stdint.h>

const uint8_t USB_CONTROLL_KO[] = {
    ...
    // Pode completar até 16 KB simulados
};

const size_t USB_CONTROLL_KO_SIZE = sizeof(USB_CONTROLL_KO);
